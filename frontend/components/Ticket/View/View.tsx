...
import {  UserticketByIdCommentAdmin ,UserticketByIdClose    } from '../../../apollo/actions'
...
const [getUserticketByIdCommentAdmin, {data:data1, loading:loading1, error}] = UserticketByIdCommentAdmin();
...
console.log(error1)
     ...
     const onSubmit = () =>{ 
      ...
      getUserticketByIdCommentAdmin({ variables: set })
